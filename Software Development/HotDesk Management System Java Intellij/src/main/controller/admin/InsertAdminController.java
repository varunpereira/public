...
import main.model.admin.InsertAdminModel;
...
//purpose: application logic for adding admin page
public class InsertAdminController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        InsertAdminModel insertAdminModel = new InsertAdminModel();
        if (insertAdminModel.isDbConnected()) {
    ...
    //purpose: button that goes back to admin home page
    ...
    //purpose: loads the add admin page
    public void InsertAdminScene(ActionEvent clickedButton) throws IOException {
        Stage window = (Stage) ((Node) clickedButton.getSource()).getScene().getWindow();
        Parent loadView = FXMLLoader.load(getClass().getResource("../../view/admin/InsertAdminView.fxml"));
        Scene scene = new Scene(loadView);
        window.setScene(scene);
        window.show();
    }

    //purpose: button that logs your account out
        ...
        if (empID.getText().trim().isEmpty() || firstName.getText().trim().isEmpty() || lastName.getText().trim().isEmpty() || age.getText().trim().isEmpty()
            ...
            try {
                if (username.getText().contains("_")) {
                    ...
                    registerModel.accountRegisteredByAdmin("admin", empID.getText(), firstName.getText(), lastName.getText(), age.getText(), role.getText(), username.getText(), password.getText(), secretQ.getText(), secretA.getText());
                    AdminHomeController adminHomeController = new AdminHomeController();
                    adminHomeController.AdminHomeScene(clickedButton);
                }
